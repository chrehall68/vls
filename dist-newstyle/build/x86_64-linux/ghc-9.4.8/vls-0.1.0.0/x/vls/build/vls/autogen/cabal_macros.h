...
/* package vls-0.1.0.0 */
#ifndef VERSION_vls
#define VERSION_vls "0.1.0.0"
#endif /* VERSION_vls */
#ifndef MIN_VERSION_vls
#define MIN_VERSION_vls(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_vls */
...
#define CURRENT_COMPONENT_ID "vls-0.1.0.0-inplace-vls"
